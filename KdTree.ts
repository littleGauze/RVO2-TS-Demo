...
class ObstacleTreeNode {
    ...
    public left: ObstacleTreeNode | null = null;
    public right: ObstacleTreeNode | null = null;
}
 ...
 */
export class KdTree {
    private static readonly MAX_LEAF_SIZE: number = 10;
    ...
    public buildObstacleTree(): void {
        ...
        const obstacles: Obstacle[] = new Array(Simulator.Instance.getNumObstacleVertices());
    ...
    public computeAgentNeighbors(agent: Agent, rangeSq: { value: number }): void {
    ...
    public queryVisibility(q1: Vector2, q2: Vector2, radius: number): boolean {
    ...
    private buildObstacleTreeRecursive(obstacles: Obstacle[]): ObstacleTreeNode | null {
        ...
        const leftObstacles: Obstacle[] = new Array(minLeft);
        const rightObstacles: Obstacle[] = new Array(minRight);
    ...
    private queryAgentTreeRecursive(agent: Agent, rangeSq: { value: number }, node: number): void {
    ...
    private queryObstacleTreeRecursive(agent: Agent, rangeSq: number, node: ObstacleTreeNode | null): void {
        if (node !== null) {
    ...
    private queryVisibilityRecursive(q1: Vector2, q2: Vector2, radius: number, node: ObstacleTreeNode | null): boolean {
        if (node === null) {
            return true;
        }
