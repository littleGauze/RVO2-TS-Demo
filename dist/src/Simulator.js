...
export class Simulator {
     ...
     */
    addAgentWithParams(position, neighborDist, maxNeighbors, timeHorizon, timeHorizonObst, radius, maxSpeed, velocity) {
        const agent = new Agent();
        agent.id = this.agents.length;
     ...
     */
    getAgentAgentNeighbor(agentNo, neighborNo) {
     ...
     */
    getAgentNumAgentNeighbors(agentNo) {
     ...
     */
    getAgentNumObstacleNeighbors(agentNo) {
     ...
     */
    getAgentObstacleNeighbor(agentNo, neighborNo) {
     ...
     */
    getAgentTimeHorizonObst(agentNo) {
     ...
     * @returns The number of the obstacle vertex succeeding the specified obstacle vertex in its polygon.
     */
    getNextObstacleVertexNo(vertexNo) {
     ...
     * @returns The number of the obstacle vertex preceding the specified obstacle vertex in its polygon.
     */
    getPrevObstacleVertexNo(vertexNo) {
